    ...
    <nav className="relative z-50 w-full bg-[#00143d] border-b border-white/5 backdrop-blur-md bg-opacity-80 sticky top-0">
      <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
        <div className="flex justify-between items-center h-20">
          {/* LEFT: Logo Section - Inspired by ChatGPT Image Jun 18, 2026, 08_54_58 AM.png */}
          ...
          {/* MIDDLE: Nav Links (Desktop) - On-Page SEO Semantic Structure */}
          <div className="hidden md:flex items-center gap-8 text-sm font-semibold tracking-wide text-slate-300">
            ...
            {/* SEO Targeted Keyword Link for Sheikhpura/Bihar Context */}
            <a
              href="#seo-marketing"
              className="hover:text-blue-400 transition-colors py-2 relative group text-blue-400"
            >
              On-Page SEO
